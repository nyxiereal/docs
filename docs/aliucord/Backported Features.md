...
:::tip Legend
- 🔌: Backported via plugin
- 🧩: Backported into Aliucord directly
...
- You can't use all .zip's at once, you'll need to decide which feature you prefer
- [How to use it](https://pastebin.com/tp1UfMY4)
